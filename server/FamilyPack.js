module.exports = {
  "blackCards": [
    "Alright, which one of you little terds is responsible for _____?!",
    "At school, I'm just Mandy. But at summer camp, I'm \"_____ Mandy.\"",
    "Attention students. This is Principal Butthead. Please remember that we do not alow _____ in the hallway. Thank you.",
    "Beep beep! _____ coming through!",
    "Before I attend your sleepover, I must inform you: toys vore me, and I don't care for sweets. I prefer _____.",
    "Bow before me, for I am the Queen of _____!",
    "Boys? No. _____? Yes!",
    "CHUNGO FEEL SICK. CHUNGO NO LIKE _____ ANYMORE.",
    "Class, pay close attention. I will now demonstrate the physics of _____.",
    "Come on, Danny. All the cool kids are doin' it. Wanna try _____?",
    ...
    "Hey guys. I just want to tell all my followers who are struggling wit _____: it DOES get better.",
    ...
    "Huddle up, Wildcats! They may be bigger. They may be faster. But we've got a secret weapon: _____.",
    "I don't really know what my mom's job is, but I think it has something to do with _____.",
    "I have invented a new sport. I call it \"_____ ball.\"",
    ...
    "MY NAME IS CHUNGO. CHUNGO LOVE _____.",
    ...
    "Thanks for watching! IF you want to seee more vids of _____, smash that subscribe.",
    ...
    "This is gonna be the best sleepover ever. Once Mom and Dad go to bed, it's time for _____!",
    "Time to put on my favorite t-shirt, the one that says \"I heart _____.\"",
    "Today we honor St. Mungo, the patron saint of _____.",
    ...
    "You don't love me, Sam. All you care about is _____.",
  ],
  "whiteCards": [
